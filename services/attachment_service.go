...
type AttachmentService interface {
	...
	// Create 添加单条记录
	Create(data *models.Attachment) (int64,error)
	// Update 修改单条记录
	Update(data *models.Attachment, columns []string) (int64,error)
	// RuanDelete 软删除单条记录
	...
	// GetWhere Sql语句
	GetWhere(sql string) []models.Attachment
}
...
func NewAttachmentService() AttachmentService {
	return &attachmentService{
		dao: dao.NewAttachmentDao(datasource.InstanceDbMaster()),
	}
}

// GetAll 列表查询
func (s *attachmentService)GetAll(q map[string]interface{}, fields []string, orderBy string, page int, limit int) (*datasource.Paginator, error)  {
...
// CountAll 统计
func (s *attachmentService) CountAll() int64 {
	return s.dao.CountAll()
}

// Create 添加单条记录
func (s *attachmentService) Create(data *models.Attachment) (int64,error) {
	// 先更新缓存
...
// Update 修改单条记录
func (s *attachmentService) Update(data *models.Attachment, columns []string) (int64,error) {
	// 先更新缓存
...
// RuanDelete 软删除单条记录
func (s *attachmentService) RuanDelete(id int) (int64, error) {
	// 先更新缓存
...
// GetWhere Sql语句
func (s *attachmentService) GetWhere(sql string) []models.Attachment {
