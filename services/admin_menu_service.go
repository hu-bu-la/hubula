...
type AdminMenuService interface {
	...
	// GetById 获取单条记录
	GetById(id int) (*models.AdminMenu, error)
	// CountAll 统计
	CountAll() int64

	// Create 添加单条记录
	Create(data *models.AdminMenu) (int64,error)
	// Update 修改单条记录
	Update(data *models.AdminMenu, columns []string) (int64,error)
	// RuanDelete 软删除单条记录
	...
	// GetWhere Sql语句
	GetWhere(sql string) []models.AdminMenu
}
...
func NewAdminMenuService() AdminMenuService {
	return &adminMenuService{
		dao: dao.NewAdminMenuDao(datasource.InstanceDbMaster()),
	}
}

// GetAll 列表查询
func (s *adminMenuService)GetAll(q map[string]interface{}, fields []string, orderBy string, page int, limit int) (*datasource.Paginator, error)  {
...
// CountAll 统计
func (s *adminMenuService) CountAll() int64 {
	return s.dao.CountAll()
}

// Create 添加单条记录
func (s *adminMenuService) Create(data *models.AdminMenu) (int64,error) {
	// 先更新缓存
...
// Update 修改单条记录
func (s *adminMenuService) Update(data *models.AdminMenu, columns []string) (int64,error) {
	// 先更新缓存
...
// RuanDelete 软删除单条记录
func (s *adminMenuService) RuanDelete(id int) (int64, error) {
	// 先更新缓存
...
// GetWhere Sql语句
func (s *adminMenuService) GetWhere(sql string) []models.AdminMenu {
