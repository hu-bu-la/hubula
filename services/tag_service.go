...
type TagService interface {
	...
	// Create 添加单条记录
	Create(data *models.Tag) (int64,error)
	// Update 修改单条记录
	Update(data *models.Tag, columns []string) (int64,error)
	// RuanDelete 软删除单条记录
	...
	// GetWhere Sql语句
	GetWhere(sql string) []models.Tag
}
...
// GetAll 列表查询
func (s *tagService)GetAll(q map[string]interface{}, fields []string, orderBy string, page int, limit int) (*datasource.Paginator, error)  {
...
// CountAll 统计
func (s *tagService) CountAll() int64 {
	return s.dao.CountAll()
}

// Create 添加单条记录
func (s *tagService) Create(data *models.Tag) (int64,error) {
	// 先更新缓存
...
// Update 修改单条记录
func (s *tagService) Update(data *models.Tag, columns []string) (int64,error) {
	// 先更新缓存
...
// RuanDelete 软删除单条记录
func (s *tagService) RuanDelete(id int) (int64, error) {
	// 先更新缓存
...
// GetWhere Sql语句
func (s *tagService) GetWhere(sql string) []models.Tag {
