...
func NewMemberService() MemberService {
	return &memberService{
		dao: dao.NewMemberDao(datasource.InstanceDbMaster()),
	}
}

// GetAll 列表查询
func (s *memberService)GetAll(q map[string]interface{}, fields []string, orderBy string, page int, limit int) (*datasource.Paginator, error)  {
...
// RuanDelete 软删除单条记录
func (s *memberService) RuanDelete(id int) (int64, error) {
	// 先更新缓存
...
// Delete 删除单条记录
func (s *memberService) Delete(id int) (int64, error) {
	// 先更新缓存
	//data := &models.Users{Id: id}
	//s.updateByCache(data, nil)
	// 再更新数据库
